...
pub fn is_isomorphic_to<T: Hash + Copy + Eq + Ord, U: Hash + Copy + Eq + Ord>(
    g1: &Graph<T>,
    g2: &Graph<U>,
) -> bool {
    fn is_isonorphic_to_rec<T: Hash + Copy + Eq + Ord, U: Hash + Copy + Eq + Ord>(
        g1: &Graph<T>,
        g2: &Graph<U>,
        unmapped1: &Vec<T>,
        unmapped2: &Vec<U>,
    ...
    fn is_valid_mapping<T: Hash + Copy + Eq + Ord, U: Hash + Copy + Eq + Ord>(
        g1: &Graph<T>,
        g2: &Graph<U>,
        mapping: &HashMap<T, U>,
    ) -> bool {
